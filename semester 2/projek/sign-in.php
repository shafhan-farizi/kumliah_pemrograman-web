...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="src/assets/img/clinic's logo.png">
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain">
                <div class="img-fluid text-center">
                  <img src="src/assets/img/clinic's logo.png" alt="" style="width: 15rem;">
                </div>
                ...
                <div class="card-body">
                  <form role="form" action="database/proses_login.php?proses=masuk" method="post">
                    ...
                    <div class="text-center">
                      ...
                      <a href="index.php" class="btn btn-outline-danger w-100 mt-4 mb-0">Back to HomePage</a>
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('src/assets/img/sign-in.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
